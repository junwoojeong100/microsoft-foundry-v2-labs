...
WORKSHEETS = {
    "en": {
        "session-notes.txt": (
            ...
            "No passwords, keys, tokens or .env. A skips the B section; B skips browser-only Labs 01/03 and Lab 07 A notes.\n\n"
            "Lab 00 - setup card\n"
            "Language / path:\n"
            "Tenant / subscription:\n"
    ...
    "ko": {
        "session-notes.txt": (
            ...
            "비밀번호·key·token·.env는 넣지 않습니다. A는 B 구역을, B는 브라우저 전용 Lab 01/03과 Lab 07 A 기록을 건너뜁니다.\n\n"
            "Lab 00 - 설정 카드\n"
            "언어 / 경로:\n"
            "Tenant / subscription:\n"
...
def learner_files(root: Path, language: str) -> dict[str, bytes]:
    ...
    files = {
        "START-HERE.txt": (
            ...
            "1. Complete docs/setup.md and the setup section of session-notes.txt. Use prepared gpt-6-sol, not the judge or a router.\n"
            ...
            "1. docs/ko/setup.md와 session-notes.txt의 설정 카드를 채웁니다. judge/router가 아닌 준비된 gpt-6-sol을 사용합니다.\n"
