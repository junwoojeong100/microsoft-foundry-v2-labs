...
**2026-09-16 확장.** 모든 Foundry 기능을 실행했다는 주장이 아니라 범위 기록입니다.
영문 작성 → 영문 촬영 → 영문 보완 → 국문 작성 → 별도 국문 촬영 → 국문 보완 순서로 제작합니다.
국문 독립 실행과 172개 동작·516장 캡처·영상 3개를 완료했습니다.
실행 성공·실패, 로컬 재생 검증과 GitHub 게시 상태는 각각 별도로 표시합니다.
...
[기존 국문 실행](live-run.md)과 [9월 15일 영상](video-summary.md)은 원래 날짜와 결과를 유지합니다.
[영문 확장 결과](../edition-results.md)를 국문 실행으로 복사하지 않습니다.
[국문 확장 결과](edition-results.md), [영상](edition-videos.md), [액션](edition-actions.md)이 별도 근거입니다.
