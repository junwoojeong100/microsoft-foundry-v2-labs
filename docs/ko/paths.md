...
**A는 Python 작성 없이 브라우저와 준비된 Lab 05 workflow 하나(Playground 또는 준비된 터미널)를 사용하며, B는 코드와 저장된 실행 기록을 다룹니다.**
...
화면은 2026-09-24 국문 녹화이고, Lab 03 B와 Lab 09 B에는 2026-09-25 보충 녹화도 있습니다. 이름·ID·답변은 본인 환경과 다릅니다
