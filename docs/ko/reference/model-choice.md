...
File Search·하이브리드 RAG·학습자가 직접 하는 Hosted 배포와 일부 확장 모듈은 이 모델로 다시 실행하지 않았습니다. 승인된 CI 릴리스와 2026-09-23~25에 다시 실행한 모듈은 이 모델을 사용했습니다([기능 범위](../coverage.md), [결과](../live-run.md#이전에-실행하지-않은-항목--2026-09-23)).
