...
[English](../../reference/glossary.md) | **한국어**
...
| Manifest / hash | 입력·설정의 목록 / 바이트 변경 확인용 지문; 모델 품질을 증명하는 값이 아님 |
...
모든 용어를 미리 알 필요는 없습니다. 이 페이지로 연결한 랩이나 문서로 돌아갑니다.
처음 시작한다면 [A 또는 B](../paths.md)를 고릅니다.
