...
| 질문 | 답 | 자세히 |
|---|---|---|
| 이번 straightforwardness 점검에서 바뀐 것은? | 오프라인 전용 준비, 올바른 터미널, 지침 입력란 교체, 저장한 baseline과 6행 CSV 보존, 실습 전용 자산의 정리 범위를 명확히 안내. 영문·국문과 복구 링크를 맞춤. 오프라인 확인이며 새 학습자 시범 운영이나 Azure 실행을 뜻하지 않음 | [초보자 최종 점검](#beginner-final-audit-20260926) |
