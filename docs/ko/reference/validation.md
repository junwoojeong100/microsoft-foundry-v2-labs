...
| 질문 | 답 | 자세히 |
|---|---|---|
| 이번 straightforwardness 점검에서 바뀐 것은? | 영문·국문의 준비·복사·재개 공백 4건 수정: 자습 준비 완료 기준 통일, 완결된 경량 복제 블록, 환경 준비 실패 시 설치 중단, 저장된 이름·버전으로 agent 재개. 오프라인 확인이며 새 학습자 시범 운영이나 Azure 실행을 뜻하지 않음 | [복사·재개 점검](#copy-resume-audit-20260925) |
