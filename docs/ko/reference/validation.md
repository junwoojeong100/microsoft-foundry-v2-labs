...
## Straightforwardness 검토: 가이드와 문서 — 2026-09-24

**5차: 가이드 100/100, 문서 98.5/100.** 이전 차수(가이드, 문서): 1차 97/100, 86.5/100 · 2차 97.5/100, 94/100 ·
3차 93.5/100, 92.5/100 · 4차 96.5/100, 92/100.
1–4차는 매번 새로운 독립 AI cold read 7개를 사용했습니다. 영문 A·영문 B·국문 가이드(D1–D10)와 영문 2개·국문 2개 문서 그룹(R1–R10)입니다.
5차는 4차 검토자들이 수정 뒤 자기 범위 전체를 다시 읽은 결과입니다.
각 항목은 10점에서 시작해 치명·주요·중간·경미 발견마다 3·2·1·0.5점을 빼고, 검토자 중 가장 낮은 점수를 씁니다.
D10과 R10은 국문 검토에서 나옵니다. 새 검토자마다 다른 작은 문제를 찾았기 때문에 2–4차 점수가 오르내렸습니다.
이는 편집 평가이며 실제 학습자 시범 운영, 학습 성공률, 측정한 완료 시간이 아닙니다.

| 가이드 | 만점 기준 | 1차 | 2차 | 3차 | 4차 | 5차 |
|---|---|---:|---:|---:|---:|---:|
| D1 | 진입과 경로 선택이 각 경로의 첫 행동까지 이어짐 | 10 | 9.5 | 10 | 10 | 10 |
| D2 | 하나의 선형 핵심 경로. 선택·담당자·과거 자료는 접거나 표시 | 10 | 10 | 9 | 10 | 10 |
| D3 | 정확한 UI 이름·파일·값이 있는 번호 매긴 명령형 단계 | 10 | 10 | 9 | 10 | 10 |
| D4 | 모든 행동·명령 뒤에 보이는 성공/실패 확인 | 10 | 9 | 9 | 10 | 10 |
| D5 | 명령이 적힌 그대로 순서대로 실행되고 출력 파일 이름이 있음 | 10 | 10 | 10 | 7 | 10 |
| D6 | 핵심 경로의 쉽고 간결한 문장 | 10 | 10 | 9 | 9.5 | 10 |
| D7 | 담당자에게 요청할 내용까지 포함한 구체적 복구 | 9 | 10 | 9 | 10 | 10 |
| D8 | 명확한 완료 기준, 올바른 A/B 다음 링크와 인계 | 10 | 10 | 10 | 10 | 10 |
| D9 | 모델·날짜·화면·링크 설명이 최신이고 일관됨 | 10 | 10 | 9.5 | 10 | 10 |
| D10 | 국문이 영문을 그대로 반영하고 자연스럽게 읽힘 | 8 | 9 | 9 | 10 | 10 |

| 문서 | 만점 기준 | 1차 | 2차 | 3차 | 4차 | 5차 |
|---|---|---:|---:|---:|---:|---:|
| R1 | 목적·대상·현재 답이 먼저 나옴 | 8 | 10 | 10 | 9.5 | 10 |
| R2 | 제목·표·anchor로 답을 바로 찾음 | 9 | 10 | 10 | 9.5 | 10 |
| R3 | 번호 매긴 절차에 수행자와 성공 확인이 있음 | 10 | 10 | 10 | 9 | 10 |
| R4 | 숫자·flag·링크·결과가 가이드·CLI·근거와 일치 | 7 | 9 | 8 | 9 | 9 |
| R5 | 사실은 한 곳에만 두고 날짜별 이력은 간결 | 9 | 10 | 10 | 9.5 | 10 |
| R6 | 짧은 문장과 설명된 용어 | 9.5 | 10 | 10 | 10 | 9.5 |
| R7 | 간결하고 일관된 근거 경계·Preview 상태·날짜 | 10 | 9 | 9 | 9 | 10 |
| R8 | 유료 호출·클라우드 쓰기·역할·정리에 승인자와 수행자 명시 | 9 | 8 | 8 | 9 | 10 |
| R9 | 모든 페이지에 다음 단계. 끊기거나 삭제된 링크 없음 | 9 | 9.5 | 10 | 9.5 | 10 |
| R10 | 국문이 영문을 그대로 반영하고 자연스럽게 읽힘 | 6 | 8.5 | 7.5 | 8 | 10 |

**검증 후 제외:** 치명 발견 두 건은 문서가 아니라 검토자 안내의 오류에서 나왔습니다.
...
**검증:** Python 3.13·3.14 각각에서 offline 테스트 287개가 통과했습니다. 새 테스트 5개가 이 기록의 계산,
...
**범위:** workshop 명령 줄, Foundry 요청 로직, prompt, 합성 정책, 평가 데이터, fixture, 녹화는 바꾸지 않았습니다
