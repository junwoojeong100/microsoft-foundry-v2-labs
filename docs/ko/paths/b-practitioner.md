...
480분 핵심 경로는 4시간 세션 두 번으로 나누는 것을 권장합니다. 배포와 C 모듈은 필수가 아닙니다.
...
| 7 | [Lab 07 B](../labs/07-evaluation.md#path-b): 통제된 평가 | 오류를 포함한 `outputs/baseline/`, `outputs/candidate/`, `outputs/final-holdout/` |
...
**권장 분할:** Day 1은 Labs 00, 02, 03, 04, 05를 다룹니다. Day 2는 Labs 06, 07, 08, 09, 11을 다룹니다.
