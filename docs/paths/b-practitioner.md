...
|---|---|---|
| 1 | [Lab 00 B](../labs/00-start.md#path-b): shared setup | Environment, authentication and fixture/live distinction |
...
| 9 | [Lab 11 B](../labs/11-capstone.md#path-b): handoff | Existing acceptance report and all preceding artifacts |
