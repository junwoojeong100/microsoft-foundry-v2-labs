...
**Do not continue into a B/C section just because it appears below an A section.**
The prepared A course remains 240 minutes including handoff and a short buffer.
...
an offline fixture or a recorded response. A missing optional feature stays **not run**.
