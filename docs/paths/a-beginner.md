...
| 5 | [Lab 05 A](../labs/05-workflows.md#path-a): prepared Hosted Playground option or one prepared sequential terminal command | `workflow-review.txt` contains the execution option, complete actual output/ID and your review |
