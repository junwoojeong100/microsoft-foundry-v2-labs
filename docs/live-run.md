...
- **[20분 배속본 MP4](assets/live-20260913/walkthrough-20min.mp4)** — 동일한 전체 흐름을 약 5.55배속으로 재생합니다.
- **전체 길이 원본 MP4:** 로컬 `outputs/live-20260913/full-headless-redacted.mp4` — 약 111분.
  대용량 전체본과 원시 실행 로그는 Git에 포함하지 않습니다.
