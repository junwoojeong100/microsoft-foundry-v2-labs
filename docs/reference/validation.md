...
|---|---|---|
| What changed after comparing public workshops? | Seven representative GitHub references were checked at immutable commits. Added optional code-along SDK exercises, a source-bound local verification report and enforcement of all completed translation hashes. No global ranking, beginner pilot or new Azure execution is claimed | [Quality contract and references](quality.md) · [Code practice](../code-along.md) |
