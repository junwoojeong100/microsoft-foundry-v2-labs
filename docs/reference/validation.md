...
2026-09-14 최신 편집 영상 두 개의 해시를 확인한 뒤 같은 비공개 저장소 범위의 동영상 첨부로 업로드했습니다.
...
각각 내장 플레이어 2개가 생성되는지 확인했습니다. 실제 private GitHub CDN에서 받은
영상 두 개의 바이트 수·SHA-256이 저장소의 최신 편집본과 같았으며,
headless Edge에서 4개 플레이어의 시작·50%·90% 위치 **12회 재생/탐색**을 확인했습니다.
...
두 영상이 재생되는 것도 확인했습니다. GitHub 인증 토큰은 리디렉션 대상에 전달하지 않았습니다.
...
기존 두 영상과 GitHub 첨부 URL은 변경하지 않았습니다. 통합본의 새 GitHub 첨부 업로드는 수행하지 않았습니다.
...
SDK 버전·의존성 검사를 통과했습니다. 문서 **31개**, 로컬 링크 **1,343개**,
CLI 예제 **54개**를 확인했습니다.
