...
File Search, hybrid RAG, a learner-run Hosted deployment and several extension modules were not re-run with it; the approved CI release and the modules re-run on September 23–25 used it ([coverage](../coverage.md), [results](../live-run.md#previously-not-run-items--september-23-2026)).
