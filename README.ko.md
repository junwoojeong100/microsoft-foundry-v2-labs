...
Lab 05 방식을 하나도 제공받지 않았다면 수업 전에 [Lab 00 B](docs/ko/labs/00-start.md#path-b)와 [Lab 02 B](docs/ko/labs/02-models.md#path-b)를 완료한 뒤,
Lab 03 B가 아니라 **[Lab 00 A](docs/ko/labs/00-start.md#path-a)**로 돌아갑니다.
