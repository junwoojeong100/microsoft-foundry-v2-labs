...
- 현재 Foundry / Projects SDK **2.x** 고정 버전은 2026-09-24에 갱신했고 그날 저녁 두 언어의 핵심 B 경로에서 실제 검증했습니다(녹화 없음). 2026-09-24 녹화는 이전 고정 버전을 사용했습니다. [버전](docs/ko/reference/versions.md)을 확인하세요.
